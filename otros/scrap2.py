...
SBR_WS_CDP = "wss://brd-customer-hl_fb1bc01c-zone-scraping_browser:53t4q6bv4fnf@brd.superproxy.io:9222"
...
def scrape_page_data(page, url):
    try:
        ...
        page.wait_for_selector('.a-price.aok-align-center.reinventPricePriceToPayMargin.priceToPay > .a-offscreen',
                               timeout=120000)
